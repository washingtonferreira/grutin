...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.menuGLC = QtWidgets.QMenu(self.menubar)
        self.menuGLC.setObjectName("menuGLC")
        ...
        self.menuGLC.addAction(self.actionGLC)
        self.menubar.addAction(self.menuGLC.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menumaquina_de_turing.setTitle(_translate("MainWindow", "Máquina de Turing"))
        self.menuGLC.setTitle(_translate("MainWindow", "Gramática Livre de Contexto"))
